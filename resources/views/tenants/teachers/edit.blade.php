    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                <i
                    class="fas fa-user-edit mr-3 text-[color:var(--color-castleton-green)] dark:text-[color:var(--color-light-castleton-green)]"></i>
                <h2
                    ...
                    <div
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="name" class="mt-1 block w-full transition-colors duration-200"
                                type="text" name="name" :value="old('name', $teacher->name)" required autofocus maxlength="255" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="email" class="mt-1 block w-full transition-colors duration-200"
                                type="email" name="email" :value="old('email', $teacher->email)" required maxlength="255" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="phone" class="mt-1 block w-full transition-colors duration-200"
                                type="tel" name="phone" :value="old('phone', $teacher->phone)" maxlength="20" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="address" class="mt-1 block w-full transition-colors duration-200"
                                type="text" name="address" :value="old('address', $teacher->address)" maxlength="255" />
                    ...
                    <div
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="subject" class="mt-1 block w-full transition-colors duration-200"
                                type="text" name="subject" :value="old('subject', $teacher->subject)" required maxlength="255" />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="bio" name="bio" rows="4" maxlength="1000"
                                ...
                                placeholder="Brief biography or description...">{{ old('bio', $teacher->bio) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="hire_date" class="mt-1 block w-full transition-colors duration-200"
                                type="date" name="hire_date" :value="old('hire_date', $teacher->hire_date)" required />
