<x-tenant-dash-component>
    ...
    <div class="min-w-full p-6">
        ...
        <div class="mx-auto max-w-3xl rounded-lg bg-white p-6 shadow-xs dark:bg-gray-800">
            <h3 class="mb-4 text-lg font-medium text-gray-900 dark:text-gray-100">Edit Teacher</h3>
            <form method="POST" action="{{ route('tenant.teachers.update', $teacher) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="name" class="mt-1 block w-full" type="text" name="name"
                            :value="old('name', $teacher->name)" required autofocus maxlength="255" />
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="email" class="mt-1 block w-full" type="email" name="email"
                            :value="old('email', $teacher->email)" required maxlength="255" />
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="address" class="mt-1 block w-full" type="text" name="address"
                            :value="old('address', $teacher->address)" maxlength="255" />
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="subject" class="mt-1 block w-full" type="text" name="subject"
                            :value="old('subject', $teacher->subject)" required maxlength="255" />
