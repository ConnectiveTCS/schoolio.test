    ...
    <div
        ...
        <div
            ...
            <h3
                ...
                <i
                    class="fas fa-edit mr-2 text-[color:var(--color-brunswick-green)] dark:text-[color:var(--color-light-brunswick-green)]"></i>
                {{ __('Edit Student') }}
            </h3>
                ...
                <div
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="name" class="mt-1 block w-full" type="text" name="name"
                            :value="old('name', $student->name)" required autofocus maxlength="255" />
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="email" class="mt-1 block w-full" type="email" name="email"
                            :value="old('email', $student->email)" required maxlength="255" />
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="phone" class="mt-1 block w-full" type="tel" name="phone"
                            :value="old('phone', $student->phone)" maxlength="20" />
                    ...
                    <div
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="parent1_name" class="mt-1 block w-full" type="text"
                                name="parent1_name" :value="old('parent1_name', $parent1->name ?? '')" maxlength="255" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="parent1_email" class="mt-1 block w-full" type="email"
                                name="parent1_email" :value="old('parent1_email', $parent1->email ?? '')" maxlength="255" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="parent1_phone" class="mt-1 block w-full" type="tel"
                                name="parent1_phone" :value="old('parent1_phone', $parent1->phone ?? '')" maxlength="20" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="parent1_address" class="mt-1 block w-full" type="text"
                                name="parent1_address" :value="old('parent1_address', $parent1->address ?? '')" maxlength="255" />
                            <x-input-error class="mt-2" :messages="$errors->get('parent1_address')" />
                        </div>

                        @if ($parent1)
                            <input type="hidden" name="parent1_id" value="{{ $parent1->id }}">
                        @endif
                    </div>
                    ...
                    <div
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="parent2_name" class="mt-1 block w-full" type="text"
                                name="parent2_name" :value="old('parent2_name', $parent2->name ?? '')" maxlength="255" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="parent2_email" class="mt-1 block w-full" type="email"
                                name="parent2_email" :value="old('parent2_email', $parent2->email ?? '')" maxlength="255" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="parent2_phone" class="mt-1 block w-full" type="tel"
                                name="parent2_phone" :value="old('parent2_phone', $parent2->phone ?? '')" maxlength="20" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="parent2_address" class="mt-1 block w-full" type="text"
                                name="parent2_address" :value="old('parent2_address', $parent2->address ?? '')" maxlength="255" />
                            <x-input-error class="mt-2" :messages="$errors->get('parent2_address')" />
                        </div>

                        @if ($parent2)
                            <input type="hidden" name="parent2_id" value="{{ $parent2->id }}">
                        @endif
                    </div>
                    ...
                    <div class="hidden">
                        <div class="mb-4">
                            ...
                            <x-text-input id="guardian_name" class="mt-1 block w-full" type="text"
                                name="guardian_name" :value="old('guardian_name', $student->guardian_name)" maxlength="255" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="guardian_contact" class="mt-1 block w-full" type="tel"
                                name="guardian_contact" :value="old('guardian_contact', $student->guardian_contact)" maxlength="20" />
