<x-tenant-dash-component>
    ...
    <div class="min-w-full p-6">
        ...
        <div class="mx-auto max-w-3xl rounded-lg bg-white p-6 shadow-xs dark:bg-gray-800">
            <h3 class="mb-4 text-lg font-medium text-gray-900 dark:text-gray-100">Edit Class</h3>
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="name" class="mt-1 block w-full" type="text" name="name"
                            :value="old('name', $class->name)" required autofocus maxlength="255" />
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="subject" class="mt-1 block w-full" type="text" name="subject"
                            :value="old('subject', $class->subject)" maxlength="255" />
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="room" class="mt-1 block w-full" type="text" name="room"
                            :value="old('room', $class->room)" maxlength="50" />
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" name="description" rows="4"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-xs focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-indigo-600 dark:focus:ring-indigo-600">{{ old('description', $class->description) }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="schedule" name="schedule" rows="3"
                            ...
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-xs focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-indigo-600 dark:focus:ring-indigo-600">{{ old('schedule', $class->schedule ? json_encode($class->schedule) : '') }}</textarea>
