        ...
        <div class="mx-auto max-w-3xl rounded-lg bg-white p-6 shadow-sm dark:bg-gray-800">
            ...
            <form method="POST" action="{{ route('tenant.users.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <select id="role" name="role" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
