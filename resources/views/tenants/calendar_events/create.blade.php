    ...
    <div
        ...
        <div
            ...
            <h3
                ...
                <i
                    class="fas fa-calendar-plus mr-3 text-[color:var(--color-castleton-green)] dark:text-[color:var(--color-light-castleton-green)]"></i>
                Add New Event
            </h3>
                ...
                <div
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="title"
                            ...
                            type="text" name="title" :value="old('title')" required autofocus maxlength="255" />
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" name="description" rows="4"
                            class="mt-1 block w-full rounded-md border-[color:var(--color-brunswick-green)] bg-white text-[color:var(--color-gunmetal)] transition-colors duration-200 focus:border-[color:var(--color-castleton-green)] focus:ring-[color:var(--color-castleton-green)] dark:border-[color:var(--color-light-brunswick-green)] dark:bg-[color:var(--color-gunmetal)] dark:text-[color:var(--color-light-gunmetal)] dark:focus:border-[color:var(--color-light-castleton-green)] dark:focus:ring-[color:var(--color-light-castleton-green)]">{{ old('description') }}</textarea>
                ...
                <div
                    ...
                    <div class="mb-4">
                        ...
                        <p
                            ...
                            If none selected, event is visible to all roles.</p>
                    ...
                    <div class="mb-4">
                        <label class="inline-flex items-center">
                            ...
                            <span
                                class="ml-2 text-sm text-[color:var(--color-gunmetal)] dark:text-[color:var(--color-light-gunmetal)]">Published
