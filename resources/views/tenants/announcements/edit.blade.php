                    ...
                    <div
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="title"
                                ...
                                type="text" name="title" :value="old('title', $announcement->title)" required autofocus />
                    ...
                    <div
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="expires_at"
                                class="mt-1 block w-full border-[color:var(--color-brunswick-green)] bg-white text-[color:var(--color-gunmetal)] transition-colors duration-200 focus:border-[color:var(--color-castleton-green)] focus:ring-[color:var(--color-castleton-green)] dark:border-[color:var(--color-light-brunswick-green)] dark:bg-[color:var(--color-gunmetal)] dark:text-[color:var(--color-light-gunmetal)] dark:focus:border-[color:var(--color-light-castleton-green)] dark:focus:ring-[color:var(--color-light-castleton-green)]"
                                type="datetime-local" name="expires_at" :value="old(
                                    'expires_at',
                    ...
                    <div
                        ...
                        @if ($announcement->hasAttachments())
                            <div class="mb-6">
                                <x-input-label
                                    class="flex items-center text-[color:var(--color-gunmetal)] transition-colors duration-200 dark:text-[color:var(--color-light-gunmetal)]">
                                    <i
                                        class="fas fa-folder mr-2 text-[color:var(--color-castleton-green)] dark:text-[color:var(--color-light-castleton-green)]"></i>
                                ...
                                <div class="mt-2 space-y-3">
                                    @foreach ($announcement->attachments as $attachment)
                                        ...
                                        @endphp
                                        <div
                                            class="flex items-center justify-between rounded-lg border border-[color:var(--color-castleton-green)] bg-[color:var(--color-light-castleton-green)] p-3 transition-colors duration-200 dark:border-[color:var(--color-light-castleton-green)] dark:bg-[color:var(--color-castleton-green)]">
                                            <div class="flex items-center space-x-3">
                                                <div class="shrink-0">
                                                    <i
                                                        class="fas {{ $iconClass }} {{ $iconColor }} text-xl"></i>
                                                </div>
                                                <div>
                                                    <p
                                            ...
                                            <div class="flex items-center space-x-3">
                                                <a href="{{ route('tenant.announcements.download', [$announcement, $attachment['filename']]) }}"
                                                    class="inline-flex items-center text-sm text-[color:var(--color-castleton-green)] transition-colors duration-200 hover:text-[color:var(--color-dark-green)] dark:text-[color:var(--color-light-castleton-green)] dark:hover:text-[color:var(--color-light-dark-green)]">
                                                    <i class="fas fa-download mr-1"></i>
                                                    Download
                                                </a>
                                                <label
                                                    class="inline-flex cursor-pointer items-center rounded border border-[color:var(--color-brunswick-green)] bg-[color:var(--color-light-brunswick-green)] px-2 py-1 transition-all duration-200 hover:bg-[color:var(--color-brunswick-green)] dark:border-[color:var(--color-light-brunswick-green)] dark:bg-[color:var(--color-brunswick-green)] dark:hover:bg-[color:var(--color-light-brunswick-green)]">
                                                    <input type="checkbox" name="remove_attachments[]"
                                                        value="{{ $attachment['filename'] }}"
                                                        class="shadow-xs rounded-sm border-[color:var(--color-brunswick-green)] bg-white text-[color:var(--color-gunmetal)] transition-colors duration-200 focus:border-[color:var(--color-gunmetal)] focus:ring-[color:var(--color-gunmetal)] dark:border-[color:var(--color-light-brunswick-green)] dark:bg-[color:var(--color-gunmetal)] dark:text-[color:var(--color-light-gunmetal)] dark:focus:border-[color:var(--color-light-gunmetal)] dark:focus:ring-[color:var(--color-light-gunmetal)]">
                                                    <span
                                                        class="ml-1 flex items-center text-xs text-[color:var(--color-gunmetal)] transition-colors duration-200 dark:text-[color:var(--color-light-gunmetal)]">
                        ...
                        <div class="mb-6">
                            <x-input-label for="attachments"
                                ...
                                {{ __('Add New Attachments (Optional)') }}
                            </x-input-label>
                            <div class="mt-1">
                        ...
                        <div class="mb-6">
                            <label
                                ...
                                <span
                                    ...
                                    {{ __('Active (announcement will be visible)') }}
                                </span>
                            </label>
